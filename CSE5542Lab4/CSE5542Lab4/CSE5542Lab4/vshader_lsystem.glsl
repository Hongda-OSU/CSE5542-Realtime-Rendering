...
#version 330 //  Comment/un-comment this line to resolve compilation errors
...
void main() 
{
    vec4 vPosition4 = vec4(vPosition.x + vOffset.x, vPosition.y + vOffset.y, vPosition.z, 1.0);
